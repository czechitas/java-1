...
public class HlavniOkno extends JFrame {
    ...
    private void priStiskuBtnVypocitat(ActionEvent e) {
        int husySamci = Integer.parseInt(editHusySamci.getText());
        int husySamice = Integer.parseInt(editHusySamice.getText());
        int kraliciSamci = Integer.parseInt(editKraliciSamci.getText());
        int kraliciSamice = Integer.parseInt(editKraliciSamice.getText());

        int husyCelkem = husySamci + husySamice;
        if (husySamci >= 1 && husySamice >= 1) {
            husyCelkem = husyCelkem + husySamice * 15;
        }
        int kraliciCelkem = kraliciSamci + kraliciSamice;
        if (kraliciSamci >= 1 && kraliciSamice >= 1) {
            kraliciCelkem = kraliciCelkem + kraliciSamice * 40;
        }

        double kgPsenice = 183.0 * 0.25 * husyCelkem;
        double radkyPsenice = kgPsenice / 2.0;
        double kgMrkve = 183.0 * 0.5 * kraliciCelkem;
        double radkyMrkve = kgMrkve / 5.0;

        editHusyCelkem.setText(Integer.toString(husyCelkem));
        editHmotnostPsenice.setText(Double.toString(kgPsenice));
        editRadkyPsenice.setText(Double.toString(radkyPsenice));

        editKraliciCelkem.setText(Integer.toString(kraliciCelkem));
    ...
    private void initComponents() {
        ...
        //---- labKg1 ----
        labKg1.setText("kg");
        labKg1.setFont(labKg1.getFont().deriveFont(labKg1.getFont().getSize() + 4f));
        ...
        //---- labKg2 ----
        labKg2.setText("kg");
        labKg2.setFont(labKg2.getFont().deriveFont(labKg2.getFont().getSize() + 4f));
