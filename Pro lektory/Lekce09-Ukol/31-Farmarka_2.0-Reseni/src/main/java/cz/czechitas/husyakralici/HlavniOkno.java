...
public class HlavniOkno extends JFrame {
    ...
    private void priStiskuBtnVypocitat(ActionEvent e) {
        ...
        double husy = prevodnik.parse(editHusy.getText());
        double kralici = prevodnik.parse(editKralici.getText());

        double kgPsenice = 183 * 0.25 * husy;
        double radkyPsenice = kgPsenice / 2.0;
        double kgMrkve = 183 * 0.5 * kralici;
